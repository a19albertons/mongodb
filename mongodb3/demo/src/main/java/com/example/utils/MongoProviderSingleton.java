 ...
 * </p>
 */
public final class MongoProviderSingleton {
    ...
    /** Almacena la instancia unica de mongoprovider */
    private static MongoProviderSingleton instance;

    /**
     * Devuelve la instancia unica de MongoProviderSingleton, creando una nueva si
     * no existe.
     * 
     * @return instancia unica de MongoProviderSingleton
     */
    public static synchronized MongoProviderSingleton getInstance() {
        if (instance == null) {
            instance = new MongoProviderSingleton();
        }
        return instance;
    }
     ...
     * </p>
     */
    private MongoProviderSingleton() {
    ...
    /**
     * Devuelve la coleccion donde guardamos partidas.
     *
     * @return coleccion MongoDB que almacena documentos de partidas
     */
